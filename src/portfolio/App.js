...
function Header() {
  ...
  return (
    <header className="pf-header">
      ...
      <nav className={`pf-nav ${menuOpen ? "active" : ""}`}>
        <a href="#about" onClick={() => setMenuOpen(false)}>About</a>
        <a href="#personal-info" onClick={() => setMenuOpen(false)}>Personal Info</a>
  ...
  return (
    <main className="pf-container">
      ...
      <section className="top-cards">
        <div className="top-card info-card" id="personal-info">
          <PersonalInfo />
        </div>
...
function HeroSection() {
  return (
    <section id="hero" className="pf-hero">
      ...
      <img
        src={avatar2}
        alt="John Lloyd Palma illustration"
        className="pf-hero-illustration"
      />
    </section>
  );
}
  ...
  return (
    <footer className="pf-footer">
      <div className="socials">
        <SocialLink
          href="https://github.com/jlpalma5"
          label="GitHub"
          icon="github"
        />
        <SocialLink
          href="https://linkedin.com/in/johnlloydpalma"
          label="LinkedIn"
          icon="linkedin"
        />
      </div>
      <p>© {new Date().getFullYear()} John Lloyd Palma</p>
    </footer>
  );
}
    ...
    >
      {icon === "github" && (
        ...
        >
          <path
            fillRule="evenodd"
            d="M8 0C3.58 0 0 3.58 0 8a8 8 0 005.47 7.59c.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2 .37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.22 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.22 2.2.82a7.52 7.52 0 012.01-.27c.68 0 1.36.09 2.01.27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.28.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8 8 0 0016 8c0-4.42-3.58-8-8-8z"
          ></path>
        </svg>
      )}
      {icon === "linkedin" && (
